...
<h4>Input Home Owner Details:</h4>
	<form action="homeownerinputdetail.spring" method="post">
		<div class="form-group">
			<label>First Name<input type="text" name="fname" maxlength="20" required></label>
		</div>
		<div class="form-group">
			<label>Last Name<input type="text" name="lname" maxlength="20" required></label>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<label>SSN<input type="text" name="ssn" maxlength="9" pattern="[0-9]{9}" required></label>
		</div>
		<div class="form-group">
			<label>Password<input type="password" name="password" maxlength="20" required></label>
		</div>
