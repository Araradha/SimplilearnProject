...
<h4>Input your Location Details:</h4>
	<form action="locationinputdetail.spring" method="post">
		...
		<div class="form-group">
			<label>Address Line 1<input type="text" name="al1" maxlength="30" required></label>
		</div>
		<div class="form-group">
			<label>City<input type="text" name="city" maxlength="15" required></label>
		</div>
		<div class="form-group">
			<label>State<input type="text" name="state" maxlength="15" required></label>
		</div>
		<div class="form-group">
			<label>Zip<input type="text" name="zip" pattern="[0-9]{6}" maxlength="6" required></label>
		</div>
		<div class="form-group">
